      ...
      >
        ...
        <nav className="space-y-2 flex-1">
          ...
          <button
            ...
            className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-white/5 text-gray-400 hover:text-white transition-all mt-6"
          >
          ...
          {openPlaylists && (
            <div className="space-y-1 pl-1 max-h-64 overflow-y-auto">
              {playlists.map((p) => (
                <button
                  key={p.id}
                  type="button"
          ...
          >
            ...
            <span className="text-xs bg-white/10 px-2 py-0.5 rounded-full">{likedSongs.length}</span>
          </button>
        </nav>
      </aside>
    </>
